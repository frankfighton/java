package com.javatpoint.rest.application;
...
public class ApplicationConfig extends Application {
  ...
  public Set<Class<?>> getClasses() {
    ...
    resources.add(com.javatpoint.rest.providor.MyJacksonJsonProvider.class);
    resources.add(com.javatpoint.rest.service.UserProfileService.class);
